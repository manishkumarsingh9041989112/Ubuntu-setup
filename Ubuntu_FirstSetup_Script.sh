...
## Run it all ,boys
    ...
    echo "This is an actual machine set-up"
    WELCOME_SCREEN  && FIRST_UPGRADE && FIRST_THINGS_FIRST && INSTALL_ALL_SOFTWARE && ENABLE_FLATPAKS && INSTALL_GNOME_SOFTWARE  && COPY_BASHRC_AND_DELETE_REST && CREATE_FOLDER_SYSTEM && REBOOT_SYSTEM
	fi
